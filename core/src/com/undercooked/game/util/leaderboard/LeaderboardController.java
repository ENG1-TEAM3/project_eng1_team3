...
public final class LeaderboardController {
	...
	public static void loadLeaderboard() {
		...
		for (GameType lType : GameType.values()) {
	...
	private static Leaderboard addLeaderboard(GameType lType, String name, String id) {
	...
	public static JsonValue asJsonValue() {
		...
		for (GameType lType : leaderboardData.keys()) {
			// Add the type
