...
public class CustomerController {
    ...
    private void computeCustomerZone(TiledMap gameMap){
        ...
        //^Split x y pairs into 2 separate arrays=======================================================================
        ...
        //^Throw exception if more than 2 unique x values exist - the rectangle is not 2 wide===========================
        ...
        //^Throw exception if the customer zone tile list does not contain tiles at the bottom index====================
        ...
        //^Throw exception if the customer zone is not a filled rectangle. It does this by looking from the maximum=====
        //y value downwards to check if a tile exists all the way down to zero, on both columns.
        this.top = ymax;
        this.bottom = 0;
