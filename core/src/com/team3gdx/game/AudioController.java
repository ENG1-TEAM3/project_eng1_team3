...
public class AudioController {
	 ...
	 * 
	 * @param musicName : String - Name of music to be returned (file name without extension)
	 ...
	 * 
	 * @param soundName :  String - Name of music to be returned (file name without extension)
	...
	/**
	 * Access Sound.dispose() or Music.dispose() for individual piece of audio and remove it from map
	 * 
	 * @param audioName : String - Name of audio instance to be disposed (file name without extension)
	 */
	 ...
	 * 
	 * @param audioName : String - Name of audio to be checked file (file name without extension)
	 ...
	 * 
	 * @param musicName : String - Name of piece of music (file name without extension)
	 ...
	 * 
	 * @param musicName : String - Name of a piece of music (file name without extension)
	 ...
	 * 
	 * @param soundName : String - Name of a sound effect (file name without extension)
	 * @param soundID : long - ID of a sound instance (Returned when sound was played)
	 * @param volume : float - Volume for music (with 1.0 corresponding to 100%)
	 */
	...
	/**
	 * Plays and loops a given piece of audio. Music will start paying if it isn't already
	 * 
	 * @param audioName : String - Name of a piece of audio (file name without extension)
	...
	/**
	 * Will stop a piece of music from looping - it will still play to the end of the piece (Will not stop a sound effect where the .stop() method must be used) 
	 * 
	 * @param musicName : String - Name of a piece of music (file name without extension)
	 */
	...
	/**
	 * Pauses a piece of audio - .play() method will resume from pre-paused position (all instances of a sound effect)
	 * 
	 * @param audioName : String - Name of a piece of audio (file name without extension)
	 */
